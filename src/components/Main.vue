<template xmlns:el-col="http://www.w3.org/1999/html">
    <div>
        <div style="margin-bottom: 5px">
            ...
            <el-button type="success" @click="resetParam">清除</el-button>

            <el-button type="primary" style="margin-left:9px" @click="add">新增</el-button>
        </div>
    <el-table :data="tableData"
    :header-cell-style="{background:'#edf6fe',color:'#3a3737'}"
    border
    >
        ...
        <el-table-column prop="roleId" label="角色" width="120">
            <template slot-scope="scope">
                <el-tag
                        ...
                        disable-transitions>{{scope.row.roleId === 0 ? '超级管理员' : (scope.row.roleId === 1 ? '快递员' : '用户')}}</el-tag>
            </template>
        </el-table-column>
        ...
        <el-table-column prop="operate" label="操作">
            <template slot-scope="scope">
                ...
                <el-popconfirm style="margin-left: 8px"
                        title="确定删除吗？"
