<template>
    <div>
        <div style="margin-bottom: 5px;">
            ...
            <el-button type="primary" style="margin-left: 5px;" @click="outPakage">出库</el-button>
        ...
        <el-table :data="tableData"
            ...
            <el-table-column prop="warehouse" label="存放货架" width="180">
            </el-table-column>
            <el-table-column prop="Pakagetype" label="包裹分类" width="180" :formatter="formatPakagetype">
            </el-table-column>
            <el-table-column prop="count" label="取件码" width="180">
            </el-table-column>
            <el-table-column prop="userId" label="取件人" :formatter="formatUserName">
            </el-table-column>
            <el-table-column prop="logistics" label="物流公司" :formatter="formatWarehouse">
            </el-table-column>
                ...
                <el-form-item label="所属物流" prop="pakagetype">
                    <el-col :span="20">
                        <el-select v-model="form.logistics" placeholder="请选择物流分类">
                            <el-option
                                    v-for="item in this.warehouseData"
                                    :key="item.id"
                                    :label="item.name"
                                    :value="item.id">
                            </el-option>
