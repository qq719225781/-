<template>
    <div>
        ...
        <el-table :data="tableData" :header-cell-style="{ background: '#f2f5fc', color: '#555555' }" border
            ...
            <el-table-column prop="receivingUserName" label="收件人" width="180">
            </el-table-column>
            <el-table-column prop="deliveryUserName" label="配送人">
            </el-table-column>
...
export default {
    ...
    methods: {
        ...
        loadPost() {
            ...
            this.$axios.post(this.$httpUrl + '/delivery/listPage', {
